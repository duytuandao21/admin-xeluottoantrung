...
export default function Page() {
  return <SettingsPage title="Quản lý Footer" subtitle="Chỉnh sửa nội dung footer website" fields={[
    ...
    { name: 'footerAbout', label: 'Mô tả về công ty', type: 'textarea', defaultValue: 'Xe Lướt Toàn Trung - Chuyên mua bán xe ô tô đã qua sử dụng uy tín hàng đầu tại TP.HCM' },
